 ...
 * 修改备注：
 */
public class BargainRuleActivity extends BaseSwipeBackActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bargain_rule);
    ...
    private void loadingUrl() {
        ...
        String url = MallApi.SERVER_WEB_URL + "/bargain-about.html?from=android";

        if (NetUtils.isNetworkConnected(BargainRuleActivity.this)) {//判断网络状态
            ...
            //进行无网络或错误处理
            Toast.makeText(BargainRuleActivity.this, "网络连接异常，请检查网络", Toast.LENGTH_SHORT).show();
            web_rule.loadUrl("file:///android_asset/error.html");
            web_rule.addJavascriptInterface(new ErrorJavaScript(BargainRuleActivity.this, handler), "android");
        }
    }
}
