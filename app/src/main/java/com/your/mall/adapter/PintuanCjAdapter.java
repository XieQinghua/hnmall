 ...
 * 修改备注：
 */
public class PintuanCjAdapter extends BaseAdapter {
    private ArrayList<PintuanBean.DataBean.ItemsPintuancjBean> list;
    private Context context;

    public PintuanCjAdapter(Context context, ArrayList<PintuanBean.DataBean.ItemsPintuancjBean> list) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            vh = new ViewHolder();
            convertView = LayoutInflater.from(context).inflate(R.layout.item_pintuan_cj, null);
